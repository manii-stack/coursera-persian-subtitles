...
| فونت زیرنویس | انتخاب فونت فارسی؛ فونت‌های نصب‌نشده روی دستگاه غیرفعال نشان داده می‌شوند |
| اصطلاحات تخصصی ترجمه نشود | اصطلاح فنی لاتین بماند یا معادل فارسی جاافتاده بگیرد |
| مدل | مدل Gemini؛ پیش‌فرض `gemini-3.5-flash-lite` |
